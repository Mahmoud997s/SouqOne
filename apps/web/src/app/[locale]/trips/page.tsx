        ...
        <div className="bg-gradient-to-b from-primary/5 to-transparent dark:from-primary/10 pb-8">
          <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6">
            <div className="mb-6">
              ...
              <p className="text-on-surface-variant text-sm mt-1">{t('tripsSubtitle')}</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 mt-6">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              <span className="material-symbols-outlined text-6xl text-on-surface-variant/30 mb-4 block">route</span>
              <p className="text-on-surface-variant text-lg font-bold">{t('tripsNoListings')}</p>
            </div>
          ) : (
            <>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
