                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {car.seller.phone && (
                          <a
                            ...
                            className="bg-[#25D366] text-white py-2.5 rounded-lg font-black text-xs hover:brightness-110 transition-all flex items-center justify-center gap-1.5"
                          >
                        ...
                        <button
                          ...
                          className="bg-surface-container-high dark:bg-surface-container-highest text-on-surface py-2.5 rounded-lg font-black text-xs hover:bg-primary hover:text-on-primary transition-all flex items-center justify-center gap-1.5"
                        >
