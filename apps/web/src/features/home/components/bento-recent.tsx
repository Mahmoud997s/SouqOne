...
const quickLinks: QuickLink[] = [
  { icon: 'build', title: 'صيانة وإصلاح', desc: 'ورش معتمدة وفنيين محترفين', href: '/coming-soon?section=services', color: 'text-blue-500' },
  { icon: 'local_car_wash', title: 'غسيل وتلميع', desc: 'غسيل بخار وتلميع سيراميك', href: '/coming-soon?section=services', color: 'text-cyan-500' },
  ...
  { icon: 'shield', title: 'تأمين سيارات', desc: 'شامل وضد الغير', href: '/coming-soon?section=insurance', color: 'text-indigo-500' },
  { icon: 'car_crash', title: 'سطحة ونش', desc: 'خدمة 24 ساعة كل عمان', href: '/coming-soon?section=services', color: 'text-rose-500' },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-8">
          ...
          <div className="flex gap-2">
            <Link href="/coming-soon?section=services" className="text-primary font-bold text-xs hover:underline">الخدمات ←</Link>
