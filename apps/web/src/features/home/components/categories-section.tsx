...
const categories = [
  ...
  { label: 'خدمات سيارات', icon: 'build', href: '/coming-soon?section=services', color: 'bg-purple-500/10 text-purple-600 dark:bg-purple-500/20 dark:text-purple-400', desc: 'صيانة وفحص' },
